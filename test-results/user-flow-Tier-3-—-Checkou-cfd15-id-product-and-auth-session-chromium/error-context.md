...
- Name: user-flow.spec.js >> Tier 3 — Checkout (Buy Page) >> buy page loads with valid product and auth session
- Location: tests\user-flow.spec.js:117:3
...
Received string:        "https://www.caramelcake.in/login.html?redirect=buy.html?product=11111111-1111-1111-1111-111111111111"
```
