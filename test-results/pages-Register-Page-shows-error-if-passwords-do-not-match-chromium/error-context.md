...
- Name: pages.spec.js >> Register Page >> shows error if passwords do not match
- Location: tests\pages.spec.js:114:3
...
Locator: .error, [class*="error"], text=match, text=password >> nth=0
Expected: visible
Error: Unexpected token "=" while parsing css selector ".error, [class*="error"], text=match, text=password". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for .error, [class*="error"], text=match, text=password >> nth=0
...
- generic [ref=e3]:
  - generic [ref=e4]:
    - generic [ref=e5]: ✨
    - heading "Join Cake Shop" [level=1] [ref=e6]
    - paragraph [ref=e7]: Create your account in seconds
  - generic [ref=e8]: ❌ Passwords do not match.
  - generic [ref=e9]:
    - generic [ref=e10]:
    ...
    - button "Create Account" [active] [ref=e22] [cursor=pointer]:
      - generic [ref=e23]: Create Account
  - generic [ref=e24]:
