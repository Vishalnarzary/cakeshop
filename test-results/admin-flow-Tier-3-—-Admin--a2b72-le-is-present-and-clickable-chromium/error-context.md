...
- Name: admin-flow.spec.js >> Tier 3 — Admin Flow >> shop open/close toggle is present and clickable
- Location: tests\admin-flow.spec.js:65:3
...
Locator: locator('#shop-toggle')
Expected: attached
Timeout: 8000ms
Error: element(s) not found

Call log:
  - Expect "toBeAttached" with timeout 8000ms
  - waiting for locator('#shop-toggle')
