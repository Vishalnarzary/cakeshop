...
- Name: admin-flow.spec.js >> Tier 3 — Admin Flow >> discounts tab shows seeded discount codes
- Location: tests\admin-flow.spec.js:157:3
...
Call log:
  - waiting for locator('button:has-text("Discount"), [data-tab="discounts"], #tab-discounts').first()
