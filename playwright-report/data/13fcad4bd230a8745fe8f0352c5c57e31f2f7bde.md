...
- Name: pages.spec.js >> Login Page >> typing 1111 in email and password reveals admin tab
- Location: tests\pages.spec.js:66:3
...
Locator: #admin-tab, [data-tab="admin"], text=Admin >> nth=0
Expected: visible
Error: Unexpected token "=" while parsing css selector "#admin-tab, [data-tab="admin"], text=Admin". Did you mean to CSS.escape it?

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for #admin-tab, [data-tab="admin"], text=Admin >> nth=0
...
- generic [ref=e2]:
  ...
  - generic [ref=e7]:
    ...
    - generic [ref=e11]:
      ...
      - button "🛡️ Admin Login" [ref=e13] [cursor=pointer]
    - generic [ref=e14]:
      - generic [ref=e15]:
    ...
    - generic [ref=e23]: Admin accounts are managed by the system administrator.
```
