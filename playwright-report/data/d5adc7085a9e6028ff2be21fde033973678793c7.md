...
- Name: admin-flow.spec.js >> Tier 3 — Admin Flow >> products tab loads product list
- Location: tests\admin-flow.spec.js:90:3
...
Call log:
  - waiting for locator('button:has-text("Products"), [data-tab="products"], #tab-products').first()
